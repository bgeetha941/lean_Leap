...
app = Flask(__name__)
# Enable CORS for all routes (BROADEST SETTINGS FOR VERCEL)
...
try:
    ...
    print(f"WARNING: AI Analyzer failed to start: {e}")
    ai_career_analyzer = None
...
def home():
    return jsonify({'success': True, 'message': 'LeanLeap API is LIVE!', 'version': '1.0.1'}), 200
